...
(function () {
    ...
    $(".copyright").wrap('<a href="http://justeenlee.com/assets/TOS.html"></a>');
})();
...
function setInitialNavProperty() {
    ...
    } else if (currentPath == "tv" || currentPath == "projects") {
...
$('img').mousedown(function (e) {
  if(e.button == 2) { // if users right click
  console.log("nothing");
    return false; // respond with nothing
  }
});
